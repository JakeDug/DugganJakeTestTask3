...
public class Rate {
    ...
    public BigDecimal calculate(Period periodStay) {
        ...
        if(kind == CarParkKind.VISITOR) {
        	...
        	BigDecimal freeTime = new BigDecimal(8.00);
        	BigDecimal discount = new BigDecimal(0.50);
        	int result = freeTime.compareTo(total);
        	...
        	BigDecimal minAmount = new BigDecimal(3.00);
        	int result = minAmount.compareTo(total);
        	...
        	BigDecimal minAmount = new BigDecimal(5.50);
        	...
        	int result = maxPayable.compareTo(total);
